    ...
    <div class="col-md-12">
        <div class="card card-nav-tabs card-plain">
            <div class="card-header ">
                <h4 class="card-title"> เพิ่มข้อมูลงาน</h4>
            </div>
            <div class="card-body ">
                @if($errors)
                ...
                <form action="{{ url('tasks-store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input name="Createby" class="form-control" readonly="readonly" value="{{Auth::user()->id}}" placeholder="{{Auth::user()->name}}">
                        </div>

                        <div class="form-group col-md-3">
                            <label>วันเวลาที่หมอบหมาย</label>
                            <input name="assign_date" class="form-control" readonly="readonly" value="{{now()}}" placeholder="{{now()}}">
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            @foreach ($department as $key)
                                <option value="{{ $key->departmentid }}">{{ $key->dmname }}</option>
                            @endforeach
                            </select>
                        </div>
                    ...
                    <a href="/tasksnews" class="btn btn-danger">ยกเลิก</a>
                </form>
            </div>
        </div>
    </div>
